...
import MessageSkeleton from "./skeletons.jsx/MessageSkeleton";
          ...
          >
            <div className="chat-image avatar">
              <div className="size-10 rounded-full border border-base-300">
                <img src={message.senderId === authUser._id ? authUser.profilePic || "./avatar.jpg"
                  : selectedUser.profilePic || "./avatar.jpg"} alt="Profile Pic" />
              </div>
            </div>
